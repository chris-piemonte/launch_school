...
function sentiment(text) {
  ...
  let positiveList = positiveWords.join(', ');
  let negativeList = negativeWords.join(', ');
  let positiveCount = positiveWords.length;
  let negativeCount = negativeWords.length;
  let sentiment;
...
Positive sentiments: ${positiveList}\n\n\
There are ${negativeCount} negative words in the text.\n\
Negative sentiments: ${negativeList}\n\n\
