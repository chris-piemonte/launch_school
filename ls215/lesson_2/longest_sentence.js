...
function longestSentence(text) {
  ...
  logSentence(sentencesAndWordCounts, longestWordCount);
...
function getLongestWordCount(sentencesAndWordCounts) {
  return Object.values(sentencesAndWordCounts).sort((num1, num2) => {
    return num2 - num1;
  })[0];
}
