...
function compareVersions(version1, version2) {
  ...
  if (/([^\d.]|^$)/.test(version1)) return null
  if (/[^\d.]|^$/.test(version2)) return null

  version1 = version1.match(/\d+/g).map(str => Number(str));
  version2 = version2.match(/\d+/g).map(str => Number(str));
...
console.log(compareVersions('1.2.04', '1.2.03') === 1);
console.log(compareVersions('9', '8') === 1);
console.log(compareVersions('5.0.0.005', '5.0.0.0.9') === 1);
console.log(compareVersions('5.0...0...005', '5...0.0....0.9') === 1);
console.log(compareVersions('5.0...0...005', '5...0.0....0.9.0000.0.0.0') === 1);
console.log(compareVersions('5.0...0...005.0.0.0.0.0', '5...0.0....0.9') === 1);
console.log(compareVersions('1.1', '1') === 1);

// version1 < version 2
console.log(compareVersions('0', '1') === -1);
console.log(compareVersions('1.2.04', '1.2.05') === -1);
console.log(compareVersions('8.9999.999.9', '9.0.0.0') === -1);
console.log(compareVersions('5.0.0.005', '5.0.0.9') === -1);
console.log(compareVersions('5....0.0....005', '5....0.0....9') === -1);
console.log(compareVersions('5....0.0....005', '5....0.0....9.0.0.0.0') === -1);
console.log(compareVersions('5....0.0....005.0.0.0.0.0.0.0.0.0', '5....0.0....9') === -1);
console.log(compareVersions('1.1', '1') === 1);

// version1 === version 2
console.log(compareVersions('0', '0') === 0);
console.log(compareVersions('1.2.04', '1.2.04') === 0);
console.log(compareVersions('1.2.04', '1.2.04.0.0.0.0') === 0);
console.log(compareVersions('8.9999.999.9', '8.9999.999.9') === 0);
console.log(compareVersions('5.0.0.005', '5.0.0.005') === 0);
console.log(compareVersions('5....0.0.005', '5.0.0......005') === 0);

// versions missing
console.log(compareVersions('0', 1) === null);
console.log(compareVersions(9, '5') === null);
console.log(compareVersions('5') === null);
console.log(compareVersions('7',) === null);
console.log(compareVersions() === null);
console.log(compareVersions('8.99&99.999.9', '8.9999.999.9') === null);
console.log(compareVersions('5.0.0.0&05', '5.0.0.0%5') === null);
