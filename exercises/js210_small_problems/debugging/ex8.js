...
// On lines 44 & 45 there is no break statement included in the switch statements so when those staements are executed the code execution 'falls through' to the rest of the switch statements below, causing additional lines to be printed
