...
// On line 23 in the definition of the `valenceOfMolecule` function there isn't the parameter for a variable number of arguments in an array. That means that `arguments` on line 26 isn't an array it is an array like opbject but doesn't have access to the Arrray instance methods like forEach. To fix it an actual variable array parameter `...arguments` must be added.
// function valenceOfMolecule(...arguments)
